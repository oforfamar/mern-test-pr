...
export const DATABASE_CONFIG = {
  development: {
    provider: 'postgresql',
    url: process.env.DATABASE_URL || 'postgresql://postgres:password@localhost:5432/recipe_organizer',
  },
  production: {
    provider: 'postgresql',
  ...
  test: {
    provider: 'postgresql',
    url: process.env.TEST_DATABASE_URL || 'postgresql://postgres:password@localhost:5432/recipe_organizer_test',
  },
};
